      ...
      <div className="cd_h1">
        ...
        <Box className="th_startsale12">
          <MDBCheckbox
            ...
            id="inlineCheckbox1"
            value="option1"
            label={<img src={Xelle} width="90px" />}
            inline
          />
          <MDBCheckbox
            name="inlineCheck"
            id="inlineCheckbox2"
            value="option2"
            label={<img src={Zelle} width="90px" />}
            inline
          />
          <MDBCheckbox
            name="inlineCheck"
          ...
          <MDBCheckbox
            ...
            id="inlineCheckbox1"
            value="option1"
            label={<img src={Paypal} width="100px" />}
            inline
          />
          <MDBCheckbox
            name="inlineCheck"
            id="inlineCheckbox1"
            value="option1"
            label={<img src={Bitcoin} width="90px" />}
            inline
          />
          <MDBCheckbox
            name="inlineCheck"
            id="inlineCheckbox1"
            value="option1"
            label={<img src={Cashapp} width="120px" />}
            inline
          />
        </Box>
        <Box>
